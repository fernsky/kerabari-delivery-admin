...
export function generateWardWiseHouseBaseAnalysis(data: ProcessedWardWiseHouseBaseData): string {
  ...
  const analysis = `
    ...
    वडा नं. ${convertToNepaliNumber(parseInt(mostDiverseWard.wardNum))} मा सबैभन्दा विविध प्रकारको आधार निर्माण पाइएको छ, जसमा ${mostDiverseWard.baseTypeCount} विभिन्न आधार प्रकारहरू समावेश छन्। यसले यस वडाको निर्माण विविधीकरण र विकासको उच्च स्तरलाई प्रतिबिम्बित गर्दछ। यस्तो विविधीकरणले स्थानीय निर्माण क्षेत्रको लचीलापन र स्थायित्वलाई बढाउन महत्वपूर्ण योगदान पुर्‍याउँछ।
