...
export default function DeceasedPopulationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Age and Gender Wise Deceased Population in Khajura Rural Municipality (गढवा गाउँपालिका)",
      ...
      url: "https://digital.gadhawamun.gov.np/profile/demographics/ward-age-gender-wise-deceased-population",
      creator: {
        "@type": "Organization",
