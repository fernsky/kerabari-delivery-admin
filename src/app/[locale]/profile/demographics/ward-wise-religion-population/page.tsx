...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका धार्मिक जनसंख्या",
      "गढवा धार्मिक विविधता",
      `गढवा ${RELIGION_NAMES_NP[topReligions[0] as string]} जनसंख्या`,
      ...topReligions.map(
        (r) => `${RELIGION_NAMES_NP[r as string]} धर्मावलम्बी गढवा`,
      ),
    ...
    return {
      title: `गढवा गाउँपालिका | धर्म अनुसार जनसंख्या | डिजिटल प्रोफाइल`,
      ...
      openGraph: {
        title: `गढवा गाउँपालिका | धर्म अनुसार जनसंख्या`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
    ...
    return {
      title: "गढवा गाउँपालिका | धर्म अनुसार जनसंख्या | डिजिटल प्रोफाइल",
      description:
        "गढवा गाउँपालिकाको प्रत्येक वडाको धार्मिक विवरण, धर्मावलम्बीहरूको संख्या र धार्मिक विविधताको विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="धार्मिक विविधता - गढवा गाउँपालिका (Religious Diversity - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिका | धर्म अनुसार जनसंख्या विश्लेषण
            </h1>
            ...
            <p>
              यस खण्डमा गढवा गाउँपालिकाको विभिन्न वडाहरूमा अवलम्बन गरिने
              धर्महरू र धर्मावलम्बीहरूको जनसंख्या सम्बन्धी विस्तृत तथ्याङ्क
              प्रस्तुत गरिएको छ। यो तथ्याङ्कले गढवा गाउँपालिकाको धार्मिक
              विविधता, सांस्कृतिक पहिचान र स्थानीय समुदायको धार्मिक स्वरूपलाई
              प्रतिबिम्बित गर्दछ।
            </p>
            <p>
              गढवा गाउँपालिका विभिन्न धर्मावलम्बी समुदायहरूको सद्भाव र
              ...
              % रहेका छन्। यस तथ्याङ्कले गढवा गाउँपालिकाको धार्मिक नीति,
            ...
            >
              गढवा गाउँपालिकामा धर्म अनुसार जनसंख्या
            </h2>
            <p>
              गढवा गाउँपालिकामा विभिन्न धर्मावलम्बीहरूको कुल जनसंख्या
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            <h2 id="major-religions" className="scroll-m-20 border-b pb-2">
              गढवा गाउँपालिकाको प्रमुख धर्महरूको विश्लेषण
            </h2>
            <p>
              गढवा गाउँपालिकामा निम्न धर्महरू प्रमुख रूपमा अवलम्बन गरिन्छन्।
              यी धर्महरूमध्ये{" "}
