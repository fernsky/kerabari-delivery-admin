...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका मातृभाषा जनसंख्या",
      "गढवा भाषिक विविधता",
      `गढवा ${LANGUAGE_NAMES[topLanguages[0]]} भाषी जनसंख्या`,
      ...topLanguages.map((l) => `${LANGUAGE_NAMES[l]} भाषी गढवा`),
      "वडा अनुसार मातृभाषा जनसंख्या",
      "भाषिक विविधता तथ्याङ्क",
      "मातृभाषा जनगणना गढवा",
    ...
    return {
      title: "गढवा गाउँपालिकामा मातृभाषा अनुसार जनसंख्या | पालिका प्रोफाइल",
    ...
    return {
      title: "गढवा गाउँपालिकामा मातृभाषा अनुसार जनसंख्या | पालिका प्रोफाइल",
      description:
        "गढवा गाउँपालिकामा वडा अनुसार मातृभाषा जनसंख्या वितरण, प्रवृत्ति र विश्लेषण। विभिन्न भाषाभाषीहरूको विस्तृत तथ्याङ्क र विजुअलाइजेसन।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="भाषिक विविधता - गढवा गाउँपालिका (Linguistic Diversity - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              <span className="font-bold">गढवा गाउँपालिकामा</span> मातृभाषा
              अनुसार जनसंख्या
            </h1>
            ...
            <p>
              यस खण्डमा गढवा गाउँपालिकाको विभिन्न वडाहरूमा बोलिने मातृभाषाहरू र
            ...
            <p>
              गढवा गाउँपालिका विभिन्न भाषाभाषी समुदायहरूको सद्भाव र सहिष्णुताको
            ...
            <p>
              गढवा गाउँपालिकामा विभिन्न मातृभाषी वक्ताहरूको कुल जनसंख्या
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा निम्न भाषाहरू प्रमुख रूपमा बोलिन्छन्। यी
              भाषाहरूमध्ये{" "}
