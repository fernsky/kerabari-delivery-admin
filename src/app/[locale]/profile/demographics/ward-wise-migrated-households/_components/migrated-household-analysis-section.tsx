        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Most Common Migration Origin in Khajura Rural Municipality
              </span>
            </h4>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {overallSummary.find(
                  ...
                  ? `गढवा गाउँपालिकामा ${localizeNumber((((overallSummary.find((item) => item.migratedFrom === "ANOTHER_DISTRICT")?.households || 0) / totalHouseholds) * 100).toFixed(2), "ne")}% आप्रवासित घरपरिवारहरू अन्य जिल्लाबाट आएका छन्।`
