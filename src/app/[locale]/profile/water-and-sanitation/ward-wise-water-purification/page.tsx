...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "केराबारी गाउँपालिका पानी शुद्धिकरण",
      "वडागत पानी शुद्धिकरण अभ्यास",
      "पानी उमाल्ने परिवार संख्या",
      "पानी फिल्टर प्रयोग दर",
      "पियूष प्रयोग गर्ने घरधुरी",
      `केराबारी पानी शुद्धिकरण तथ्याङ्क ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];
    ...
    const descriptionNP = `केराबारी गाउँपालिकामा वडा अनुसार पानी शुद्धिकरण विधिहरूको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ले ${mostCommonTypeName} विधि प्रयोग गर्दछन्। विभिन्न वडाहरूमा पानी शुद्धिकरण विधिहरूको विस्तृत विश्लेषण।`;
    ...
    return {
      title: "पानी शुद्धिकरण विधिहरू | केराबारी गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="पानी शुद्धिकरण विधिहरू - केराबारी गाउँपालिका (Water Purification Methods - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकामा पानी शुद्धिकरणको अवस्था
            </h1>
            ...
            <p>
              ...
              यस खण्डमा केराबारी गाउँपालिकाका विभिन्न वडाहरूमा प्रयोग गरिने
            ...
            <p>
              केराबारी गाउँपालिकामा पानी शुद्धिकरणका प्रमुख विधिहरू र तिनको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकामा पानी शुद्धिकरण विधिहरूको विश्लेषण गर्दा,
            ...
            <p>
              केराबारी गाउँपालिकामा पानी शुद्धिकरण अभ्यासहरू सुधार गर्न निम्न
            ...
            <p className="mt-6">
              यी सिफारिसहरू कार्यान्वयन गरेर, केराबारी गाउँपालिकामा पानी
