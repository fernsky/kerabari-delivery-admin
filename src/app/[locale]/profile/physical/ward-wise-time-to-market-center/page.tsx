...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका बजार केन्द्र पहुँच",
    ...
    // Create description
    const descriptionNP = `गढवा गाउँपालिकामा बजार केन्द्रसम्म पुग्ने समय सम्बन्धी विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(under15MinPercentage, "ne")}% (${localizeNumber(under15MinHouseholds.toLocaleString(), "ne")}) घरधुरीले १५ मिनेटभित्र बजार केन्द्र पुग्न सक्छन्।`;
    ...
    return {
      title:
        "बजार केन्द्र पुग्न लाग्ने समयको अवस्था | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="बजार केन्द्र पुग्न लाग्ने समय - गढवा गाउँपालिका (Time to Market Center - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको अवस्था
            </h1>
            ...
            <p>
              ...
              पुर्‍याउँछ। यस खण्डमा गढवा गाउँपालिकाको विभिन्न वडाहरूमा बजार
            ...
            <p>
              गढवा गाउँपालिकामा बजार केन्द्रसम्म पुग्न लाग्ने समयको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा बजार केन्द्र पहुँचको विश्लेषण गर्दा, समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
              )}
            ...
            <p>
              गढवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको
              ...
              वडागत आवश्यकता र प्राथमिकताका आधारमा लक्षित कार्यक्रम र पूर्वाधार
              विकास गरेर बजार केन्द्रहरूको पहुँच सुधार गर्न सकिन्छ।
            </p>
          </div>
        </section>
      </div>
