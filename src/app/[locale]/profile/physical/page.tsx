...
export const metadata: Metadata = {
  title: "केराबारी गाउँपालिका भौतिक पूर्वाधार | डिजिटल प्रोफाइल",
  description:
    "केराबारी गाउँपालिकाको भौतिक पूर्वाधार सम्बन्धी तथ्याङ्क: सार्वजनिक यातायात, बजार केन्द्र पहुँच, खाना पकाउने इन्धन, विद्युत स्रोत र घरायसी सुविधाहरू सम्बन्धी विस्तृत विवरण।",
  keywords: [
    "केराबारी गाउँपालिका",
    "भौतिक पूर्वाधार",
    "यातायात पहुँच",
...
const physicalInfrastructureCategories = [
  {
    ...
    description:
      "केराबारी गाउँपालिकामा घरपरिवारले सार्वजनिक यातायातमा पुग्न लाग्ने समयको वडागत विवरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "केराबारी गाउँपालिकामा घरधुरीहरूले नजिकको बजार केन्द्रसम्म पुग्न लाग्ने समयको वडागत विवरण।",
  ...
  },
  {
    ...
    description:
      "केराबारी गाउँपालिकामा घरपरिवारले खाना पकाउन प्रयोग गर्ने इन्धनको प्रकार र त्यसको वडागत वितरण।",
  ...
  },
  {
    ...
    description:
      "केराबारी गाउँपालिकामा घरपरिवारले बत्ती बाल्न प्रयोग गर्ने विद्युतको स्रोत र त्यसको वडागत वितरण।",
  ...
  },
  {
    ...
    description:
      "केराबारी गाउँपालिकामा घरपरिवारको आधुनिक सुविधा तथा घरायसी उपकरणहरूमा पहुँचको वडागत विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="केराबारी गाउँपालिका भौतिक पूर्वाधार"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            केराबारी गाउँपालिकाको भौतिक पूर्वाधार
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              केराबारी गाउँपालिकाको भौतिक पूर्वाधार सम्बन्धी प्रोफाइलमा
        ...
        <section id="physical-infrastructure-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              केराबारी गाउँपालिकाको भौतिक पूर्वाधार सम्बन्धी विस्तृत
        ...
        <section id="improvement-strategies" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              केराबारी गाउँपालिकामा भौतिक पूर्वाधारको अवस्था सुधार गर्न निम्न
