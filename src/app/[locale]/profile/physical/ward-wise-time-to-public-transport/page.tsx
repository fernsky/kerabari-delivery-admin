...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका सार्वजनिक यातायात पहुँच",
    ...
    // Create description
    const descriptionNP = `गढवा गाउँपालिकामा सार्वजनिक यातायातसम्म पुग्ने समय सम्बन्धी विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(under15MinPercentage, "ne")}% (${localizeNumber(under15MinHouseholds.toLocaleString(), "ne")}) घरधुरीले १५ मिनेटभित्र सार्वजनिक यातायात पुग्न सक्छन्।`;
    ...
    return {
      title:
        "सार्वजनिक यातायात पुग्न लाग्ने समयको अवस्था | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सार्वजनिक यातायात पुग्न लाग्ने समय - गढवा गाउँपालिका (Time to Public Transport - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको अवस्था
            </h1>
            ...
            <p>
              ...
              अवस्था बुझ्न मद्दत पुर्‍याउँछ। यस खण्डमा गढवा गाउँपालिकाको
            ...
            <p>
              गढवा गाउँपालिकामा सार्वजनिक यातायातसम्म पुग्न लाग्ने समयको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा सार्वजनिक यातायात पहुँचको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
            ...
            <p>
              गढवा गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
