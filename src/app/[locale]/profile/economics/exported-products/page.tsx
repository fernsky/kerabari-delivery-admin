...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "केराबारी गाउँपालिका निर्यातित उत्पादन",
      "केराबारी निर्यातित वस्तुहरू",
      "निर्यातित सामान केराबारी",
      "केराबारी निर्यात सूची",
      "आर्थिक प्रोफाइल केराबारी",
      "निर्यातित वस्तु विश्लेषण",
      "निर्यातित उत्पादनहरूको प्रवृत्ति",
      `केराबारी ${totalProducts} निर्यातित उत्पादनहरू`,
    ];
    ...
    const descriptionNP = `केराबारी गाउँपालिकाको निर्यातित उत्पादनहरूको विस्तृत सूची, प्रवृत्ति र विश्लेषण। कुल ${totalProducts} निर्यातित उत्पादनहरू पालिकाबाट निर्यात गरिएका छन्। यी निर्यातित वस्तुहरूको विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="निर्यातित उत्पादनहरू - केराबारी गाउँपालिका (Exported Products - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकाबाट निर्यातित उत्पादनहरू
            </h1>
            ...
            <p>
              यस खण्डमा केराबारी गाउँपालिकाबाट निर्यात गरिने विभिन्न
            ...
            <p>
              केराबारी गाउँपालिकाबाट दर्ता भएका कुल {totalProducts} निर्यातित
            ...
            <p>
              केराबारी गाउँपालिकाबाट निर्यात गरिएका उत्पादनहरूको सूची
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकाबाट निर्यात गरिने उत्पादनहरूको प्रवृत्ति र
