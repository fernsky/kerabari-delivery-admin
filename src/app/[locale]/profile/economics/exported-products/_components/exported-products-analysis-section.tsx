      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        ...
        <div className="space-y-4 mt-3">
          <div className="bg-card p-3 rounded border">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              अन्तरराष्ट्रिय र राष्ट्रिय बजारमा केराबारी निर्यातको सम्भावना
              उच्च छ
            </p>
          </div>
          ...
          <div className="bg-card p-3 rounded border">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              केराबारीका उत्पादनहरू गुणस्तर र मूल्यमा प्रतिस्पर्धी छन्
            </p>
          </div>
        </div>

        <p className="mt-5">
          केराबारी गाउँपालिकाको निर्यात प्रवर्द्धन रणनीति सम्बन्धी थप
