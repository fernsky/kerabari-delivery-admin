...
interface CropDiseaseAnalysisSectionProps {
  cropSummary: Array<{
    crop: string;
    cropName: string;
    pestsCount: number;
...
export default function CropDiseaseAnalysisSection({
  cropSummary,
  totalCrops,
  totalPests,
  totalDiseases,
  ...
  mostAffectedCrop,
  avgIssuesPerCrop,
}: CropDiseaseAnalysisSectionProps) {
  // Find least affected crop
  const leastAffectedCrop = cropSummary[cropSummary.length - 1];
  ...
  const diseasesByCategory = cropSummary.reduce(
    (acc, crop) => {
  ...
  const pestsByCategory = cropSummary.reduce(
    (acc, crop) => {
  ...
  const seoAttributes = {
    ...
    "data-most-affected-crop":
      mostAffectedCrop &&
      `${mostAffectedCrop.cropName} / ${CROP_TYPES_EN[mostAffectedCrop.crop] || mostAffectedCrop.crop}`,
    ...
    <>
      ...
      >
        <div className="bg-muted/50 rounded-lg p-4 text-center min-w-[200px] border">
          <h4 className="text-lg font-medium mb-2">कुल बालीहरू</h4>
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            ...
            {mostAffectedCrop && (
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    backgroundColor:
                      CROP_COLORS[mostAffectedCrop.crop] || "#3498DB",
                  }}
                ></div>
                <div>
            ...
            <div className="mt-4">
              {/* Top affected crops visualization */}
                ...
                <div key={index} className="mt-3">
                  ...
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min((crop.totalIssues / Math.max(...cropSummary.map((c) => c.totalIssues))) * 100, 100)}%`,
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <div className="mt-6 pt-4 border-t">
              <h5 className="font-medium mb-3">कम प्रभावित बाली</h5>
              {leastAffectedCrop && (
                <div className="text-center">
                  <p className="text-lg font-bold">
                    {leastAffectedCrop.cropName}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {localizeNumber(
                      leastAffectedCrop.totalIssues.toString(),
                      "ne",
                    )}{" "}
                    कुल समस्या मात्र
                  </p>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  {mostAffectedCrop?.cropName || ""} मा देखिन्छ, जसमा{" "}
                  {localizeNumber(
              ...
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  रहेका छन्। यसले पालिकाको बाली संरक्षण रणनीति निर्धारणमा सहायता
                  गर्छ।
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  <strong>औसत समस्या:</strong> प्रत्येक बालीमा औसतमा{" "}
            ...
            <div className="space-y-3">
              <div>
                ...
                <ul className="text-xs space-y-1 ml-4">
                  <li>
                    • {mostAffectedCrop?.cropName || ""} मा विशेष ध्यान
                    दिनुपर्ने
                  </li>
                  <li>
