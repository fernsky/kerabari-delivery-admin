...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका वार्षिक आय",
      "वार्षिक उत्पादनको पर्याप्तता",
      `गढवा ${MONTHS_SUSTAINED_NAMES[sortedMonthsSustained[0]]} आय पर्याप्तता`,
      ...sortedMonthsSustained.map(
        (r) => `${MONTHS_SUSTAINED_NAMES[r]} आय पर्याप्तता गढवा`,
      ),
      "वडा अनुसार वार्षिक आय",
      "आर्थिक स्वावलम्बन तथ्याङ्क",
      "आय पर्याप्तता सर्वेक्षण गढवा",
      `गढवा कुल घरपरिवार संख्या ${totalHouseholds}`,
    ];
    ...
    const descriptionNP = `गढवा गाउँपालिकामा वडा अनुसार वार्षिक आयको पर्याप्तता वितरण, प्रवृत्ति र विश्लेषण। कुल घरपरिवार संख्या ${totalHouseholds} मध्ये ${MONTHS_SUSTAINED_NAMES[sortedMonthsSustained[0]]} (${monthsSustainedCounts[sortedMonthsSustained[0]]}) सबैभन्दा ठूलो समूह हो, त्यसपछि ${MONTHS_SUSTAINED_NAMES[sortedMonthsSustained[1]]} (${monthsSustainedCounts[sortedMonthsSustained[1]]})। वार्षिक आयको पर्याप्तताको विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;
            ...
            <section>
              <div className="relative rounded-lg overflow-hidden mb-8">
                <Image
                  ...
                  width={1200}
                  height={400}
                  alt="वार्षिक आयको पर्याप्तता - गढवा गाउँपालिका (Yearly Income Sustenance - Khajura Rural Municipality)"
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl">
                <h1 className="scroll-m-20 tracking-tight mb-6">
                  गढवा गाउँपालिकामा वार्षिक आयको पर्याप्तता
                </h1>
                ...
                <p>
                  गढवा गाउँपालिकामा कुल {totalHouseholds.toLocaleString()}{" "}
                ...
                <p>
                  गढवा गाउँपालिकामा वार्षिक आयको पर्याप्तता अनुसार
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl mt-8">
                ...
                <p>
                  गढवा गाउँपालिकाका घरपरिवारहरूको वार्षिक आयको पर्याप्तता
                  ...
                  %) मात्र रहेको देखिन्छ। यसले गढवामा खाद्य सुरक्षा, आर्थिक
                ...
                <p>
                  माथि प्रस्तुत गरिएका तथ्याङ्कहरू गढवा गाउँपालिकाको घरधुरी
