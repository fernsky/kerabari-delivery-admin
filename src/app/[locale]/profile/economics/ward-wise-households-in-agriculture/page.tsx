...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका कृषि परिवार",
      "गढवा कृषि पशुपालन घरधुरी",
      "वडा अनुसार कृषि परिवार",
      "कृषि पशुपालनमा संलग्न परिवार",
      "कृषि जनसंख्या वितरण",
      `गढवा कृषि परिवार संख्या ${localizeNumber(totalInvolved.toString(), "ne")}`,
      "गढवा गैरकृषि परिवार संख्या",
    ];
    ...
    return {
      title:
        "कृषि वा पशुपालनमा आबद्ध घरपरिवार | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कृषि वा पशुपालनमा आबद्ध घरपरिवार - गढवा गाउँपालिका (Households Involved in Agriculture - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको वितरण
            </h1>
            ...
            <p>
              कृषि नेपालको अर्थतन्त्रको मेरुदण्ड हो र गढवा गाउँपालिकामा पनि
            ...
            <p>
              गढवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध र आबद्ध नभएका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको विश्लेषण
              गर्दा, समग्रमा
            ...
            <p>
              गढवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको
