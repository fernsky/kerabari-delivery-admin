...
export default function IrrigationSourceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Irrigation Source Types in Khajura Rural Municipality (बुद्धशान्ति गाउँपालिका)",
      ...
      url: "https://digital.buddhashantimun.gov.np/profile/economics/municipality-wide-irrigation-source",
      creator: {
        "@type": "Organization",
