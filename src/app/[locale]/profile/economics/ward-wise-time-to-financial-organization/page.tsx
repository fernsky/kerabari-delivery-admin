...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "वित्तीय संस्थामा पुग्न लाग्ने समय | गढवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वित्तीय संस्थामा पुग्न लाग्ने समय - गढवा गाउँपालिका (Time to Financial Organizations - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा वित्तीय संस्थासम्मको पहुँच
            </h1>
            ...
            <p>
              ...
              पार्दछ। यस खण्डमा गढवा गाउँपालिकाको विभिन्न वडाहरूमा नागरिकले
            ...
            <p>
              गढवा गाउँपालिकामा वित्तीय संस्थामा पुग्न लाग्ने समयको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा वित्तीय संस्थामा पुग्ने समयको विश्लेषण
              गर्दा, समग्रमा
            ...
            <p>
              गढवा गाउँपालिकामा वित्तीय संस्थामा पुग्न लाग्ने समयको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकामा वित्तीय संस्थामा पुग्न लाग्ने समयको
