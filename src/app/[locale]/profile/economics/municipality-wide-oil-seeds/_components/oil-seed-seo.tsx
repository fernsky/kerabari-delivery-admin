...
export default function OilSeedSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Oil Seed Types in Khajura Rural Municipality (बुद्धशान्ति गाउँपालिका)",
      ...
      url: "https://digital.buddhashantimun.gov.np/profile/economics/municipality-wide-oil-seeds",
      creator: {
        "@type": "Organization",
