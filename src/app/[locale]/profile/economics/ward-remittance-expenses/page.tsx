...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका रेमिटेन्स खर्च",
      "गढवा विप्रेषण उपयोग",
