...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "केराबारी गाउँपालिका जग्गा स्वामित्व",
      "केराबारी जग्गा स्वामित्व प्रकार",
      "वडा अनुसार जग्गा स्वामित्व",
      "निजी जग्गा स्वामित्व",
      "सार्वजनिक जग्गा स्वामित्व",
      "गुठी जग्गा स्वामित्व",
      "गाउँ ब्लक जग्गा स्वामित्व",
      `केराबारी घरपरिवार संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];
    ...
    const descriptionNP = `केराबारी गाउँपालिकाको वडा अनुसार जग्गा स्वामित्वको वितरण र विश्लेषण। कुल ${localizeNumber(totalHouseholds.toString(), "ne")} घरपरिवार मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) परिवार ${LAND_OWNERSHIP_TYPES[mostCommonType] || mostCommonType} जग्गामा बसोबास गर्दछन्। विभिन्न वडाहरूमा जग्गा स्वामित्वको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार | केराबारी गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार - केराबारी गाउँपालिका (Land Ownership Types by Households - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकामा जग्गा स्वामित्वको प्रकार अनुसार घरपरिवार
            </h1>
            ...
            <p>
              ...
              ब्लक लगायतका प्रकारहरू प्रचलनमा छन्। केराबारी गाउँपालिकामा पनि
              यी विभिन्न प्रकारका जग्गा स्वामित्वमा बसोबास गर्ने घरपरिवारहरू
              रहेका छन्।
            </p>
            <p>
              केराबारी गाउँपालिकाको जग्गा स्वामित्व सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              केराबारी गाउँपालिकामा जग्गा स्वामित्वका प्रमुख प्रकारहरू र
            ...
            <p>
              स्वामित्वको विश्लेषण गर्दा, केराबारी गाउँपालिकाका{" "}
              {localizeNumber(
                (
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकामा जग्गा स्वामित्वको प्रकारले भूमि सुरक्षा र
            ...
            <p>
              केराबारी गाउँपालिकाको जग्गा स्वामित्व अवस्थाको विश्लेषणबाट
            ...
            <p className="mt-6">
              केराबारी गाउँपालिकामा जग्गा स्वामित्वको वर्तमान अवस्थाले जग्गा
