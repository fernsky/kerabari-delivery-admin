...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका घरायसी कामकाज",
      "घरायसी कामकाजमा समय वितरण",
      `गढवा ${TIME_SPENT_NAMES_NP[topTimeCategories[0]]} घरायसी काम`,
      ...
      `गढवा जनसंख्या घरायसी काम ${totalPopulation}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी कामकाज - गढवा गाउँपालिका (Household Chores - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समय
            </h1>
            ...
            <p>
              यस खण्डमा गढवा गाउँपालिकाको विभिन्न वडाहरूमा घरायसी कामकाजमा
            ...
            <p>
              गढवा गाउँपालिकामा कुल {totalPopulation.toLocaleString()}{" "}
            ...
            <p>
              घरायसी कामकाजमा खर्चिने समय अनुसार गढवा गाउँपालिकाको जनसंख्या
              वितरण निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समयको विश्लेषण गर्दा
