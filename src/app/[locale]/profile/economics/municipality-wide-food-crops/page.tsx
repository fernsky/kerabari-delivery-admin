...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "केराबारी गाउँपालिका खाद्यान्न बाली",
      "केराबारी खाद्यान्न उत्पादन",
      "पालिका स्तरीय खाद्यान्न तथ्याङ्क",
      "धान उत्पादन केराबारी",
      "मकै उत्पादन तथ्याङ्क",
      "गहुँ उत्पादन",
      `केराबारी खाद्यान्न बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `केराबारी कृषि आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];
    ...
    const descriptionNP = `केराबारी गाउँपालिकाको खाद्यान्न बाली उत्पादन र बिक्री विश्लेषण। कुल ${localizeNumber(totalProduction.toFixed(2), "ne")} मेट्रिक टन खाद्यान्न उत्पादन मध्ये ${localizeNumber(mostProducedPercentage, "ne")}% (${localizeNumber(mostProducedAmount.toFixed(2), "ne")} टन) ${FOOD_CROP_TYPES[mostProducedCrop] || mostProducedCrop} रहेको छ। पालिका स्तरीय खाद्यान्न बालीको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "खाद्यान्न बालीको प्रकार अनुसार उत्पादन र बिक्री | केराबारी गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खाद्यान्न बालीको प्रकार अनुसार उत्पादन र बिक्री - केराबारी गाउँपालिका (Food Crops by Production and Sales - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकामा खाद्यान्न बालीको प्रकार अनुसार उत्पादन र
              बिक्री
            </h1>
            ...
            <p>
              खाद्यान्न बाली केराबारी गाउँपालिकाको प्रमुख कृषि उत्पादनहरू
            ...
            <p>
              केराबारी गाउँपालिकाको खाद्यान्न बाली सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              केराबारी गाउँपालिकामा उत्पादित प्रमुख खाद्यान्न बालीहरू र तिनको
            ...
            <p>
              खाद्यान्न बालीको विश्लेषण गर्दा, केराबारी गाउँपालिकामा उत्पादित
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकामा खाद्यान्न बालीको उत्पादनले खाद्य
            ...
            <p>
              केराबारी गाउँपालिकाको प्रमुख खाद्यान्न बालीको उत्पादकत्व र
            ...
            <p>
              केराबारी गाउँपालिकाको खाद्यान्न बालीको अवस्थाको विश्लेषणबाट
            ...
            <p className="mt-6">
              केराबारी गाउँपालिकामा खाद्यान्न बालीको वर्तमान अवस्थाले अझै पनि
