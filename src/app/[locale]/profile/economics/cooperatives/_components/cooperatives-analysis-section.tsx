...
export default function CooperativesAnalysisSection({
  ...
  return (
    <>
      ...
      <p className="mt-4">
        केराबारी गाउँपालिकाका सहकारी संस्थाहरूले विभिन्न प्रकारका वित्तीय,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        <div className="border rounded-lg p-6 bg-muted/30">
          ...
          <p className="text-muted-foreground text-sm mb-4">
            केराबारीमा सबैभन्दा लोकप्रिय सहकारी प्रकार, जुन कुल सहकारीको
            {localizeNumber(
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Main Cooperative Types in Khajura Rural Municipality
              </span>
            </h4>
            {primaryCooperative && (
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          <p className="text-sm">
            केराबारी गाउँपालिकामा सञ्चालित सहकारी संस्थाहरूले स्थानीय
