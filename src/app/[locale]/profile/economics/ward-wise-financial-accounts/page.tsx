...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    // Create description
    const descriptionNP = `केराबारी गाउँपालिकामा वित्तीय खाताहरूको वितरणको विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(bankPercentage, "ne")}% (${localizeNumber(bankTotal.toLocaleString(), "ne")}) घरधुरीले बैंकमा पहुँच राख्छन्। वडा ${localizeNumber(bestAccessWard, "ne")} मा सबैभन्दा राम्रो पहुँच छ, जहाँ ${localizeNumber(bestAccessPercentage.toFixed(2), "ne")}% घरधुरीले १५ मिनेट भित्र वित्तीय संस्था पुग्न सक्छन्।`;
    ...
    return {
      title: "वित्तीय खाताको वितरण | केराबारी गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वित्तीय खाताको वितरण - केराबारी गाउँपालिका (Distribution of Financial Accounts - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकामा वित्तीय खाताहरूको वितरण
            </h1>
            ...
            <p>
              ...
              यस खण्डमा केराबारी गाउँपालिकाको विभिन्न वडाहरूमा नागरिकले
            ...
            <p>
              केराबारी गाउँपालिकामा वित्तीय खाताको वितरण निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकामा वित्तीय खाताहरूको विश्लेषण गर्दा, समग्रमा
            ...
            <p>
              केराबारी गाउँपालिकामा वित्तीय खाताहरूको वितरणको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी केराबारी गाउँपालिकामा वित्तीय खाताहरूको वितरणको विश्लेषणले
