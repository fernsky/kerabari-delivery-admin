                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b-2">
                        <th className="text-left py-2">फलफूल प्रकार</th>
      ...
      <section id="historical-trend">
        ...
        <Card className="border-2">
          <CardContent className="pt-6">
            ...
            <div className="prose prose-sm">
              <p>
                पछिल्ला वर्षहरूमा आँप उत्पादनमा क्रमिक वृद्धि भएको देखिन्छ। २०७८
                मा {localizeNumber("35.4", "ne")} मेट्रिक टन उत्पादन भएकोमा २०८०
                मा बढेर {localizeNumber("40.3", "ne")} मेट्रिक टन पुगेको छ।
              </p>
              <p className="mt-2">
                त्यसैगरी, रुखकटहर र लिची उत्पादनमा पनि निरन्तर वृद्धि भएको
                देखिन्छ। यो तथ्याङ्कले बुद्धशान्ति गाउँपालिकामा फलफूल बालीको
