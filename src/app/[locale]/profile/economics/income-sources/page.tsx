...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "केराबारी गाउँपालिका आयस्रोत",
      "केराबारी घरपरिवार आय",
      `केराबारी ${INCOME_SOURCE_NAMES_NP[topIncomeSources[0]]} घरपरिवार`,
      ...topIncomeSources.map(
        (r) => `${INCOME_SOURCE_NAMES_NP[r]} आय केराबारी`,
      ),
      "वडा अनुसार आयस्रोत",
      "आय विविधता तथ्याङ्क",
      "आर्थिक जनगणना केराबारी",
      `केराबारी कुल घरपरिवार ${totalHouseholds}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरपरिवारको आयस्रोत - केराबारी गाउँपालिका (Household Income Sources - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              केराबारी गाउँपालिकामा घरपरिवारको आयस्रोत
            </h1>
            ...
            <p>
              यस खण्डमा केराबारी गाउँपालिकाको विभिन्न वडाहरूमा बसोबास गर्ने
            ...
            <p>
              केराबारी गाउँपालिकामा विविध आयस्रोतमा निर्भर घरपरिवारहरू बसोबास
            ...
            <p>
              केराबारी गाउँपालिकामा विभिन्न आयस्रोतमा निर्भर घरपरिवारहरूको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              केराबारी गाउँपालिकामा निम्न आयस्रोतहरू प्रमुख रूपमा देखिएका
