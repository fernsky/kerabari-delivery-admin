...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका दालबाली",
      "गढवा दालहरुको उत्पादन",
      "पालिका स्तरीय दालबाली तथ्याङ्क",
      "मसुरो उत्पादन गढवा",
      "चना उत्पादन तथ्याङ्क",
      "केराउ उत्पादन",
      `गढवा दालबाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `गढवा दालबाली आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];

    const keywordsEN = [
      "Khajura Rural Municipality pulses",
    ...
    return {
      title:
        "दालबालीको प्रकार अनुसार उत्पादन र बिक्री | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="दालबालीको प्रकार अनुसार उत्पादन र बिक्री - गढवा गाउँपालिका (Pulses by Production and Sales - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा दालबालीको प्रकार अनुसार उत्पादन र बिक्री
            </h1>
            ...
            <p>
              दालबाली गढवा गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक हो।
            ...
            <p>
              गढवा गाउँपालिकाको दालबाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              गढवा गाउँपालिकामा उत्पादित प्रमुख दालबालीहरू र तिनको उत्पादन
            ...
            <p>
              दालबालीको विश्लेषण गर्दा, गढवा गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा दालबालीको उत्पादनले पोषण सुरक्षामा
            ...
            <p>
              गढवा गाउँपालिकाको प्रमुख दालबालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              गढवा गाउँपालिकाको दालबालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              गढवा गाउँपालिकामा दालबालीको वर्तमान अवस्थाले अझै पनि कृषि
