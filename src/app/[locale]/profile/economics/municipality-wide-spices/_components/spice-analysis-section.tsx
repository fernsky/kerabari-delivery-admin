...
interface SpiceAnalysisSectionProps {
...
export default function SpiceAnalysisSection({
  overallSummary,
  totalProduction,
  totalSales,
  totalRevenue,
...
}: SpiceAnalysisSectionProps) {
  // Find most significant spices
  const primarySpice = overallSummary.length > 0 ? overallSummary[0] : null;
  const secondarySpice = overallSummary.length > 1 ? overallSummary[1] : null;

  // Find most commercialized spice (highest sales to production ratio)
  const mostCommercializedSpice = overallSummary
    .filter((spice) => spice.production > 0) // Avoid division by zero
  ...
  const seoAttributes = {
    ...
    "data-most-common-spice":
      overallSummary.length > 0
        ? `${overallSummary[0].typeName} / ${SPICE_TYPES_EN[overallSummary[0].type] || overallSummary[0].type}`
        : "",
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            ...
            data-analysis-type="spice-type-analysis"
            data-percentage={
              overallSummary.length > 0
                ? (
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Main Spice in Khajura Rural Municipality
              </span>
            </h4>
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  backgroundColor: primarySpice
                    ? SPICE_COLORS[
                        primarySpice.type as keyof typeof SPICE_COLORS
                      ] || "#e67e22"
                    : "#e67e22",
                }}
              ></div>
              <div>
                <p className="text-2xl font-bold">
                  {primarySpice?.typeName || ""}
                </p>
                <p className="text-sm text-muted-foreground mt-1">
                  {localizeNumber(
                    primarySpice
                      ? (
                          (primarySpice.production / totalProduction) *
                          100
                        ).toFixed(2)
                      : "0",
                    "ne",
                  ...
                  % (
                  {localizeNumber(
                    primarySpice?.production.toFixed(2) || "0",
                    "ne",
                  )}{" "}
                  मेट्रिक टन)
                </p>
            ...
            <div className="mt-4">
              {/* Top 3 spice types visualization */}
                  ...
                  <div className="w-full bg-muted h-2 rounded-full mt-1 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor:
                          SPICE_COLORS[
                            item.type as keyof typeof SPICE_COLORS
                          ] || "#e67e22",
                      }}
                    ></div>
                  </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <p className="text-xl font-bold">
                    {mostCommercializedSpice?.typeName || ""}
                  </p>
                  <p className="text-sm text-blue-500 font-medium">
                    {localizeNumber(
                      mostCommercializedSpice
                        ? (
                            (mostCommercializedSpice.sales /
                              mostCommercializedSpice.production) *
                            100
                          ).toFixed(2)
                        : "0",
                      "ne",
          ...
          <div className="bg-card p-4 rounded border">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex gap-2">
                ...
                <span>
                  <strong>उत्पादन वितरण:</strong> पालिकामा सबैभन्दा बढी मसलाबाली{" "}
                  {localizeNumber(
                    primarySpice
                      ? (
                          (primarySpice.production / totalProduction) *
                  ...
                  % ({primarySpice?.typeName || ""}) र त्यसपछि{" "}
                  {localizeNumber(
                    secondarySpice
                      ? (
                          (secondarySpice.production / totalProduction) *
                          100
                        ).toFixed(1)
                      : "0",
                    "ne",
                  )}
                  % ({secondarySpice?.typeName || ""}) उत्पादन हुने गर्दछ।
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  आन्तरिक उपभोगमा प्रयोग हुन्छ। यसले पालिकाको मसलाबाली
              ...
              <li className="flex gap-2">
                ...
                <span>
                  <strong>खाद्य मूल्य:</strong> मसलाबालीहरू खाना स्वादिष्ट बनाउन
                  र औषधीय गुणका लागि महत्वपूर्ण छन्।{" "}
                  {localizeNumber(selfConsumption.toFixed(2), "ne")} मेट्रिक टन
                  मसलाबाली स्थानीय उपभोगमा प्रयोग हुँदा पालिकाको खाद्य
                  स्वादिष्टता र पोषण सुरक्षामा योगदान पुर्‍याउँछ।
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  मसलाबाली बिक्रीबाट प्राप्त हुन्छ।
                </span>
              </li>
            </ul>
          </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-full bg-muted h-4 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(totalRevenue / (totalProduction * 1000 * spiceAnalysis.averagePricePerKg)) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <span className="text-sm font-medium">
