...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      ...
      "बुद्धशान्ति वडागत आर्थिक जनसंख्या",
      "जनसांख्यिकी वर्गीकरण बुद्धशान्ति",
      "कार्यसक्षम उमेर समूह",
      "लिङ्ग अनुसार आर्थिक जनसंख्या",
      "आर्थिक सक्रियता विश्लेषण",
      "१५-५९ वर्ष उमेर जनसंख्या",
      `बुद्धशान्ति कुल आर्थिक जनसंख्या ${totalPopulation}`,
    ];
      ...
      <div className="flex flex-col gap-8">
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              यस खण्डमा बुद्धशान्ति गाउँपालिकाको विभिन्न वडाहरूमा आर्थिक रूपमा
            ...
            <p>
              बुद्धशान्ति गाउँपालिकामा उमेर समूह अनुसार आर्थिक रूपमा सक्रिय
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              बुद्धशान्ति गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्याको अवस्था
