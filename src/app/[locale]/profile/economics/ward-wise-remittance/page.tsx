...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "वडा अनुसार रेमिट्यान्स वितरण | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      ...
      <div className="flex flex-col gap-8">
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा रेमिट्यान्सको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              ...
              परिचालन गर्न सकेमा गढवा गाउँपालिकाको समृद्धि र आर्थिक
