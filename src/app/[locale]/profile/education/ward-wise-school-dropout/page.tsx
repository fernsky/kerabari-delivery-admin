...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका विद्यालय छाड्ने कारण",
      "स्कूल ड्रपआउट",
      "वडागत शैक्षिक त्याग",
    ...
    // Create description
    const descriptionNP = `गढवा गाउँपालिकामा विद्यालय छाड्नुका कारणहरूको विश्लेषण। कुल ${localizeNumber(totalDropouts.toLocaleString(), "ne")} जनसंख्या मध्ये ${localizeNumber(economicDropoutPercentage, "ne")}% (${localizeNumber(economicDropouts.toLocaleString(), "ne")}) जनाले आर्थिक कारणले विद्यालय छोडेका छन्।`;
    ...
    return {
      title:
        "विद्यालय छाड्ने कारणहरूको अवस्था | गढवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="विद्यालय छाड्ने कारणहरू - गढवा गाउँपालिका (School Dropout Causes - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको अवस्था
            </h1>
            ...
            <p>
              ...
              प्रणालीको सुधारका लागि महत्वपूर्ण छन्। यस खण्डमा गढवा
            ...
            <p>
              गढवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको वितरण निम्नानुसार
              रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                dropoutGroupPercentages.ECONOMIC.toFixed(2),
                "ne",
            ...
            <p>
              गढवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको विश्लेषणले
