...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "गढवा गाउँपालिका खोप कभरेज",
      "बाल खोप कार्यक्रम",
      "आधारभूत खोप सेवा",
      `पूर्ण खोप कभरेज ${fullyImmunizedCoverage.toFixed(1)}%`,
      `DPT-HepB-Hib3 कभरेज ${dptHib3Coverage.toFixed(1)}%`,
      "गढवा गाउँपालिकामा खोप सेवा",
      "खोप कभरेज विश्लेषण",
    ];

    const keywordsEN = [
      "Khajura Rural Municipality immunization coverage",
    ...
    // Create description
    const descriptionNP = `गढवा गाउँपालिकामा आधारभूत खोप सेवाको विश्लेषण। आर्थिक वर्ष ${fiscalYearLabel} मा पूर्ण खोप कभरेज ${localizeNumber(fullyImmunizedCoverage.toFixed(1), "ne")}%, DPT-HepB-Hib3 कभरेज ${localizeNumber(dptHib3Coverage.toFixed(1), "ne")}%, र दादुरा-रुबेला कभरेज ${localizeNumber(measlesRubella1Coverage.toFixed(1), "ne")}% रहेको छ।`;
    ...
    return {
      title: "खोप सेवा र कभरेज | गढवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        "गढवा गाउँपालिकामा आधारभूत खोप सेवा र कभरेजको अवस्था र विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खोप सेवा र कभरेज - गढवा गाउँपालिका (Immunization Services and Coverage - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              गढवा गाउँपालिकामा खोप सेवा र कभरेजको अवस्था
            </h1>
            ...
            <p>
              यस खण्डमा गढवा गाउँपालिकाको आर्थिक वर्ष{" "}
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              गढवा गाउँपालिकामा खोप सेवाको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              यसरी गढवा गाउँपालिकाको खोप सेवाको अवस्थामा सुधार ल्याउन स्पष्ट
